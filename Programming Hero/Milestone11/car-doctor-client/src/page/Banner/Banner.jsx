...
const Banner = () => {
    ...
    return (
        <div className="carousel w-full h-[600px] mb-7">
            <div id="slide1" className="carousel-item relative w-full">
                <img src={b1} className="w-full rounded-lg" />
                <div className="absolute h-full flex items-center rounded-lg left-0 right-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] bottom-0">
